...
Aadhaar is a 12 digit identification number that can be obtained voluntarily
by Indian citizens, non-residents passport holders of India and resident
foreign nationals, if they're eligible. The number is issued by Unique
Identification Authority of India (UIDAI).

Aadhaar is made up of 12 numeric characters, a unique 11 digit number and
1 check digit calculated using Verhoeff algorithm. The numbers are generated
in a random, non-repeating sequence and do not begin with 0 or 1.
