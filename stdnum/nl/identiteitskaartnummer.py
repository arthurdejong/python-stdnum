# identiteitskaartnummer.py - functions for handling Dutch Passport Number.
# coding: utf-8
#
...
The 6 characters inbetween can be either or.

The letter "O" is never used to prevent it from being confused with the number "0".
Zeros are thus allowed, but are not used anymore in numbers issued after December 2019.
