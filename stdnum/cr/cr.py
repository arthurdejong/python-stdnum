...
"""CR (Cédula de Residencia, also know as DIMEX or Documento de Identificación
Migratorio para Extranjeros, Costa Rica foreigners ID number).

The Cédula de Residencia (CR) is an identifier of foreigners in Costa Rica.
