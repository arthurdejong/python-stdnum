...
"""CPF (Cédula de Persona Física, also known as Cédula de Identidad, Costa Rica
physical person ID number).

The Cédula de Persona Física (CPF) is an identifier of physical persons.

This number consists of 10 digits in the form 0P-TTTT-AAAA where P represents
