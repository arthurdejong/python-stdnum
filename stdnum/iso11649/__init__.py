# __init__.py - functions for performing the ISO 11649 algorithms
#
...
"""Collection of the ISO 11649 Structured Creditor Reference algorithms.

This package provides a number of modules for verification
of numbers using the ISO 11649 algorithm.
...
11649 standard these functions can be validated and perhaps improved.
"""
